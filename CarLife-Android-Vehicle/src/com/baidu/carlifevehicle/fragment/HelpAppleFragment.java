...
public class HelpAppleFragment extends BaseFragment {

    private static final String TAG = "HelpAppleFragment";
    ...
    private static HelpAppleFragment mHelpAppleFragment;

    public static HelpAppleFragment getInstance() {
        if (mHelpAppleFragment == null) {
            mHelpAppleFragment = new HelpAppleFragment();
        }

        return mHelpAppleFragment;
    }

    public HelpAppleFragment() {
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mTitle.setText(getString(R.string.help_apple_title));
        ...
        mAndroidLayout.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                if (mFragmentManager != null) {
                    mFragmentManager.showFragment(WifiHelpFragment.getInstance());
                }
            }
        });
